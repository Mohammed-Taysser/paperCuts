...
import { EventAPI, get_event_by_id } from '../api/Localhost';
...
function EventsDetails() {
  ...
  const [currentEvent, setCurrentEvents] = useState(get_event_by_id(id));

  useEffect(() => {
    if (is_jsonServer_down) {
      setCurrentEvents(get_event_by_id(id));
    } else {
      get_events_api();
    }
  }, [is_jsonServer_down]);
