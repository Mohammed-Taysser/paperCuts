...
function TabAndNav(props) {
	...
	const Navs = () => {
		return (
			<ul className='nav nav-tabs' id='additional-details-tabs' role='tablist'>
	...
	const NavsContent = () => {
		return (
			<div
				className='tab-content border p-4'
				id='additional-details-tabsContent'
			>
				<div
				...
				>
					<div className='content p-1 mt-3'>
						<p className='text-muted m-0 lead'>
